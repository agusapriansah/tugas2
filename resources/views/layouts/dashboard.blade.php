  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
        <div class="navbar-brand brand-logo mr-1" href="{{ route('home') }}"><img src="{{ asset('sb-admin-2/img/logo12.png') }}" class="mr-2" alt="Logo"/></div>
      </a>
      ...
      <li class="nav-item {{ (request()->is('master/*')) ? 'active' : '' }}">
        ...
        <div id="collapsePagesMaster" class="collapse nav-item {{ (request()->is('master/*')) ? 'show' : '' }}" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item {{ (request()->is('master/Produk*')) ? 'active' : '' }}" href="{{ route('get.Produk') }}">Produk</a>
            <a class="collapse-item {{ (request()->is('master/Produsen*')) ? 'active' : '' }}" href="{{ route('get.Produsen') }}">Produsen</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item {{ (request()->is('about')) ? 'active' : '' }}">
        <a class="nav-link" href="{{ route('get.About') }}">
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Pilih "Logout" jika kami yakin ingin keluar.</div>
